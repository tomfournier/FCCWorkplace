...
energy         = 240.0
collider       = 'FCC-ee'
inputDir       = '/afs/cern.ch/work/l/lia/private/FCC/FCCWorkplace/outputs_HInvjj/Validation_final/'
yaxis          = ['lin']
stacksig       = ['nostack']
#stacksig       = ['nostack']
formats        = ['pdf','png']
outdir         = '/afs/cern.ch/work/l/lia/private/FCC/FCCWorkplace/outputs_HInvjj/Validation_plots/'
...
colors["ZZ_nunuqq"] = ROOT.kRed
colors["WW_lvqq"] = ROOT.kBlue

plots = {}
plots['mumuH'] = {'signal':{'ZZ_nunuqq':['output_ee_ZZ_nunuqq']},
                  'backgrounds':{'WW_lvqq':["output_ee_WW_lvqq"]
                                 }
                }
legend = {}

legend['ZZ_nunuqq'] = 'eeZZnunuqq'
legend['WW_lvqq'] = 'eeWWlvqq'
