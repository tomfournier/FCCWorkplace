...
processList = {
    ...
    "wzp6_ee_nuenueZ_ecm365":{'chunks':10},
    'p8_ee_tt_ecm365':{'chunks':20}
    #'wzp6_ee_mumuH_ecm365':{'fraction':0.02}
}
...
outputDirEos= "/eos/user/l/lia/FCCee/TopHiggs/mumu/training_estimation/"
eosType = "eosuser"
...
userBatchConfig="/afs/cern.ch/work/l/lia/private/FCC/NewWorkFlow/FCCeePhysicsPerformance/case-studies/higgs/mH-recoil/FCCAnalyses-config/TopHiggs/userBatch.Config"
#USER DEFINED CODE
import ROOT
