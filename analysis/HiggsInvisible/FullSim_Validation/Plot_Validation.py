...
if __name__ == "__main__":
    input_dir = "outputs_HInvjj/Validation_final"
    output_dir = "/eos/user/l/lia/www/FCC/HiggsInv/FullSim_Validation"
    root_files = [
        "output_ee_WW_enuenu_sel0_NoCuts_histo.root",
        "output_ee_WW_munumunu_sel0_NoCuts_histo.root",
        "output_ee_WW_lvqq_sel0_NoCuts_histo.root"
    ]
