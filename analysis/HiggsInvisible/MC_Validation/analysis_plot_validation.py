...
energy         = 240.0
collider       = 'FCC-ee'
inputDir       = '/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsInvisible/lia/MC_Validation/final/'
yaxis          = ['lin','log']
stacksig       = ['stack','nostack']
#stacksig       = ['nostack']
formats        = ['pdf','png']
outdir         = '/eos/user/l/lia/www/FCC/HiggsInv/MC_Validation/'
