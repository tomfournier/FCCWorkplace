...
processList = {
    ...
    'wzp6_ee_WW_enuenu_ecm240_p6decay':{'fraction':1.} #Run 100% of the statistics in one file named <outputDir>/p8_ee_ZH_ecm240_out.root (example on how to change the output name)
