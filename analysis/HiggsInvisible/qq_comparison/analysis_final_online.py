...
inputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsInvisible/lia/qq_comparison/stage1"

#Input directory where the files produced at the pre-selection level are
outputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/HiggsInvisible/lia/qq_comparison/final"
...
cutList = {
            "NoSel":"return true",
            "sel1":"jets_no==2",
            "sel2":"jets_no==2 && muons_no==0 && electrons_no==0",
            "sel3":"jets_no==2 && muons_no==0 && electrons_no==0 && visible_mass[0] > 86 && visible_mass[0] < 105",
            "sel_BNL1":"jets_no==2 && muons_no==0 && electrons_no==0 && visible_mass[0] > 86 && visible_mass[0] < 105 && visible_pt[0] > 15",
            "sel_BNL2":"jets_no==2 && muons_no==0 && electrons_no==0 && visible_mass[0] > 86 && visible_mass[0] < 105 && visible_pt[0] > 20",
         }
...
histoList = {
    ...
    "visible_pt": {"name": "visible_pt", "title": "Visible p_{T} [GeV]", "bin": 200, "xmin": 0, "xmax": 200},
    "visible_costheta": {"name": "visible_costheta", "title": "Visible cos(#theta)", "bin": 200, "xmin": -1, "xmax": 1},
