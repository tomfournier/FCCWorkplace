...
runBatch    = False
outputDir="/afs/cern.ch/work/l/lia/private/FCC/FCCWorkplace/outputs_HInvjj/test2/"
eosType = "eosuser"
#Optional: ncpus, default is 4
nCPUS       = 4
...
class RDFanalysis():
    ...
    def analysers(df):
        df2 = (
            ...
            .Define("status2",  'MCParticle::sel_genStatus(22)(Particle)')
            .Define("Z_MC",  "MCParticle::sel_pdgID( 23, false) ( status2 )") 
            #.Define("Z_MC",  "MCParticle::sel_pdgID( 23, false) ( MCParticles )")
